...
export default function ValueProp() {
    ...
    return (
        <section className='flex w-dvw min-h-dvh bg-primary items-center justify-center pt-[74px]'>
            <div className='w-full max-w-300 grid md:grid-cols-[3fr_5fr] gap-8 page-padding'>
