...
export default function Drawer({
    ...
    const contentMaxWidth = contentSize === 'small' ? 'max-w-[480px]' : 'max-w-screen-md';
    ...
    return (
        ...
        >
            ...
            >
                <header className={cx('w-full flex items-center justify-between gap-4 mb-8', contentMaxWidth)}>
                ...
                <div
                    id={descriptionId}
                    className={cx('w-full', contentMaxWidth)}
                >
                    {children}
                </div>
            </div>
