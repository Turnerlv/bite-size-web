...
export const TextArea = React.forwardRef(function TextArea(
    ...
    const { onChange: restOnChange, defaultValue: defaultValueProp, ...spreadRest } = rest;
    const [value, setValue] = React.useState(defaultValueProp || '');
    ...
    const errorClasses = error
        ? 'border-error-border text-error focus-visible:ring-error focus-visible:border-error-border'
        : '';
